...
window.onload=function()
{
    ...
    var aMenus=document.getElementById("menu_list").getElementsByTagName("li");
    var aIcon=oBtn.getElementsByTagName('div');
    ...
    for(var i=0;i<aMenus.length;i++)
    {
        ...
        aMenus[i].onclick=function()
        {
            ...
            oTitl.innerHTML=this.getAttribute('title');
    ...
    oBtn.onclick=function()
    {
        ...
        if(this.off)
        {
            ...
            aIcon[1].className='icon_show';
        }
        else
        {
            setCss(this,{$Transform:"rotate(0deg)"});
            aIcon[0].className='icon_show';
        }
        for(var i=0;i<aMenus.length;i++)
        {
            if(this.off)
